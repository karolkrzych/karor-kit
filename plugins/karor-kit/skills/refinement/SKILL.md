...
2. Digest into three buckets, this order:
   ...
   - **Ticket candidates** — numbered; each: title, 2-3 line summary, estimate guess, model label guess, MISSING pieces for litmus test.
...
4. Explicit approval ("push 1, 3") -> expand approved to full template, create via MCP. Complete -> Todo; gapped -> Backlog.
